...
send(msg.chat_id_, msg.id_, 1, "*📬┇ تم الغاء الاذاعه للكل للمشتركين *\n", 1, "md") 
...
if database:get( 'SNIEBR:'..bot_id.."charge:"..msg.chat_id_) then
...
if not database:get( 'SNIEBR:'..bot_id.."charge:"..msg.chat_id_) then

database:set( 'SNIEBR:'..bot_id.."charge:"..msg.chat_id_,true)
...
local list = database:smembers('SNIEBR:'..bot_id.."groups")  
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'SNIEBR Chat'
link = database:get('SNIEBR:'..bot_id.."group:link"..v) or ''
MNSH = database:smembers('SNIEBR:'..bot_id..'creator:'..v)
MDER = database:smembers('SNIEBR:'..bot_id..'owners:'..v)
MOD = database:smembers('SNIEBR:'..bot_id..'mods:'..v)
ASAS = database:smembers('SNIEBR:'..bot_id..'creatorbasic:'..v)
if k == 1 then
t = t..'"'..v..'":{"SNIEBR":"'..NAME..'",'
else
t = t..',"'..v..'":{"SNIEBR":"'..NAME..'",'
...
local json_file, res = https.request("https://raw.githubusercontent.com/SNIEBRabas/files_SNIEBR/master/files_SNIEBR/"..file)
if res == 200 then
...
local files_SNIEBR = database:smembers("files"..bot_id)
...
if (text and text == 'تعين كليشه المطور') then
...
send(msg.chat_id_, msg.id_, 1, '✔️┇الاذاعه للكل بالفعل تم تفعيلها', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '✔️┇تم تفعيل اذاعه للكل البوت', 1, 'md')
datahmade:del('SNIEBR:'..bot_id..'bc:groups')
end
end
if (text and text == 'تعطيل الاذاعه') then
if datahmade:get('SNIEBR:'..bot_id..'bc:groups') then
send(msg.chat_id_, msg.id_, 1, '🔌┇الاذاعه للكل بالفعل تم تعطيلها', 1, 'md')
else
send(msg.chat_id_, msg.id_, 1, '🔌┇تم تعطيل اذاعه للكل البوت', 1, 'md')
...
if (text and text == 'حذف كليشه المطور') and tonumber(msg.sender_user_id_) == tonumber(sudo_add) then
...
------------------------------------------------------------------------
if is_sudo(msg) then
if text and text == "اذاعه للكل" then 
...
send(msg.chat_id_, msg.id_, 1, '☑┇ الاذاعه للكل معطله ', 1, 'md')
end
end
------------------------------------------------------------------------
if text=="اذاعه للكل خاص" and msg.reply_to_message_id_ == 0 then 
if (not datahmade:get('SNIEBR:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) then
...
t = 'آلمطور آلاساسي 👨🏻‍💻'
elseif is_sudo(msg) then
t = datahmade:get("SNIEBR:name_sudo"..bot_id..msg.chat_id_)  or 'مطور مميز 👨🏽‍🔧'
elseif is_creatorbasic(msg) then
t =  datahmade:get("SNIEBR:name_cre"..bot_id..msg.chat_id_) or 'منشئ اساسي 👨🏻‍🚀'
elseif (datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and datahmade:get("SNIEBR:all_if:"..datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
t = datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_)
...
------------------------------------------------------------------------
if text == 'معاني' or text =='المعاني' and datahmade:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
