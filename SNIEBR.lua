...
if datahmade:sismember("thsake:gog"..bot_id, chat_id) then
var = true
else 
var = false
end
...
if Files == "files_SNIEBR" or Files == "Fastinstall.sh" or Files == "install.sh" or Files == "install_user.sh" or Files == "libs" or Files == "README.md" or Files == "start.lua" or Files == "sudo.lua" or Files == "tg" or Files == "ts" or Files == "TsAu" or Files == "SNIEBR.lua" then
else
...
local f = load("files_SNIEBR/"..files_SNIEBR[i].."")
if f ~= "ok" then
if f:match("^(.*)('b')(.*)$") 
or f:match("^(.*)('o')(.*)$") 
or f:match("^(.*)('t')(.*)$") 
...
datahmade:set("lock_tag:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_sarha:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_word:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_edit:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_lllll:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_gif:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_files:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_mark:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_photo:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_stecker:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_video:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_audeo:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_voice:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_contact:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_fwd:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_link:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_username:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_botAndBan:SNIEBR"..Chat..bot_id,"ok");datahmade:set("lock_new:SNIEBR"..Chat..bot_id,"ok")
end
...
datahmade:sadd("thsake:gog"..bot_id,idg) 
datahmade:sadd( 'SNIEBR:'..bot_id.."groups",idg) 
datahmade:set( 'SNIEBR:'..bot_id.."charge:"..idg,true)
Add_local(idg)
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
datahmade:sadd('SNIEBR:'..bot_id..'creator:'..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
datahmade:sadd('SNIEBR:'..bot_id..'owners:'..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
datahmade:sadd('SNIEBR:'..bot_id..'mods:'..idg,idmod)  
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
datahmade:sadd('SNIEBR:'..bot_id..'creatorbasic:'..idg,idASAS)  
end;end
if v.linkgroup then
if v.linkgroup ~= "" then
datahmade:set('SNIEBR:'..bot_id.."group:link"..idg,v.linkgroup)   
end;end;end
...
local list = redis:smembers('SNIEBR:'..bot_id..'sudo:kekore')
...
redis:del('SNIEBR:'..bot_id..'sudo:kekore')
end
...
local keko1 = redis:get('SNIEBR:'..bot_id..'sudo:keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
local test = redis:get('SNIEBR:'..bot_id..'sudo:msg'..msg.sender_user_id_..''..msg.chat_id_..'')
if keko1 == 're' then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الرد', 1, 'md')
redis:set('SNIEBR:'..bot_id..'sudo:keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'no')
...
redis:set('SNIEBR:'..bot_id..'sudo:keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 're')
...
redis:sadd('SNIEBR:'..bot_id..'sudo:kekore', text)
return false end
end
if text and text:match("^(.*)$") then
local keko1 = redis:get('SNIEBR:'..bot_id..'sudo:keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
redis:del('SNIEBR:'..bot_id.."sudo:addreply1:document:gp"..text)
redis:del('SNIEBR:'..bot_id.."sudo:addreply1:audio:gp"..text)
redis:del('SNIEBR:'..bot_id..'sudo:keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
redis:srem('SNIEBR:'..bot_id..'sudo:kekore', text)
return false
end
end
if text == 'اضف رد للكل' and is_devahmad(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد اضافتها ', 1, 'md')
redis:set('SNIEBR:'..bot_id..'sudo:keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'msg')
return false 
end
if text == 'حذف رد للكل' and is_devahmad(msg) then
send(msg.chat_id_, msg.id_, 1, '📜┇ ارسل الكلمة التي تريد حذفها ', 1, 'md')
redis:set('SNIEBR:'..bot_id..'sudo:keko1'..msg.sender_user_id_..''..msg.chat_id_..'', 'nomsg')
return false 
end
...
elseif (datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) and datahmade:get("SNIEBR:all_sl:"..datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..msg.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
redis:del('SNIEBR:'..bot_id..'kekore'..msg.chat_id_..'')
end
...
redis:sadd('SNIEBR:'..bot_id..'kekore'..msg.chat_id_..'', text)
return false end
end
if text and text:match("^(.*)$") then
local keko1 = redis:get('SNIEBR:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
redis:del('SNIEBR:'..bot_id.."addreply1:document:gp"..text..msg.chat_id_)
redis:del('SNIEBR:'..bot_id.."addreply1:audio:gp"..text..msg.chat_id_)
redis:del('SNIEBR:'..bot_id..'keko1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
------------------------------------------------------------------------
if datahmade:get("SNIEBR:set_if_bc_new:pin"..bot_id..msg.sender_user_id_) and is_sudo(msg) then  
datahmade:del("SNIEBR:set_if_bc_new:pin"..bot_id..msg.sender_user_id_)
local pro = datahmade:scard('SNIEBR:'..bot_id..'pro:groups') or 0
if text then 
local gpss = datahmade:smembers( 'SNIEBR:'..bot_id.."groups") or 0
for i=1, #gpss do
send(gpss[i], 0, 1, text, 1, 'html')	
datahmade:set('SNIEBR:'..bot_id..'Msg_Text'..gpss[i],text) 
end					
end
if (data.message_.content_.sticker_) then 
...
for i=1, #gpss do
tdcli.sendSticker(gpss[i], 0,0, 1, nil, data.message_.content_.sticker_.sticker_.persistent_id_)
datahmade:set('SNIEBR:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.sticker_.sticker_.persistent_id_) 
end
elseif (data.message_.content_.voice_) then 
gpss = datahmade:smembers( 'SNIEBR:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendVoice(gpss[i], 0,0, 1, nil, data.message_.content_.voice_.voice_.persistent_id_)
datahmade:set('SNIEBR:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.voice_.voice_.persistent_id_) 
end
elseif (data.message_.content_.video_) then 
gpss = datahmade:smembers( 'SNIEBR:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendVideo(gpss[i], 0,0, 1, nil, data.message_.content_.video_.video_.persistent_id_)
datahmade:set('SNIEBR:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.video_.video_.persistent_id_) 
end
elseif (data.message_.content_.animation_) then 
gpss = datahmade:smembers( 'SNIEBR:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendDocument(gpss[i], 0,0, 1, nil, data.message_.content_.animation_.animation_.persistent_id_)
datahmade:set('SNIEBR:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.animation_.animation_.persistent_id_) 
end
elseif (data.message_.content_.document_) then
gpss = datahmade:smembers( 'SNIEBR:'..bot_id.."groups") or 0
for i=1, #gpss do
tdcli.sendDocument(gpss[i], 0,0, 1, nil, data.message_.content_.document_.document_.persistent_id_)
datahmade:set('SNIEBR:'..bot_id..'Msg_Text'..gpss[i],data.message_.content_.document_.document_.persistent_id_) 
end
elseif (data.message_.content_.photo_) then
local id_keko = nil
if data.message_.content_.photo_.sizes_[0] then
...
for i=1, #gpss do
tdcli.sendPhoto(gpss[i], 0, 0, 1, nil, id_keko,(msg.content_.caption_ or " "))		
datahmade:set('SNIEBR:'..bot_id..'Msg_Text'..gpss[i],id_keko) 
end
end
gpss = datahmade:smembers( 'SNIEBR:'..bot_id.."groups") or 0
send(msg.chat_id_, msg.id_, 1, '☑┇تم نشر الرساله في {'..(#gpss)..'} مجموعه ', 1, 'md')
...
------------------------------------------------------------------------
local keko2 = redis:get('SNIEBR:'..bot_id..'hres1'..msg.sender_user_id_..'')
if keko2 == 'msg' then
if text:match("^(.*)$") then
send(msg.chat_id_, msg.id_, 1, '☑┇تم حفظ الكليشه يمكنك اظهارها بارسال الامر', 1, 'html')
...
------------------------------------------------------------------------
if datahmade:get("lock_lllll:SNIEBR"..msg.chat_id_..bot_id)  and msg.content_.ID ~= "MessageChatAddMembers" then  
...
for k,v in pairs(list) do   
NAME = 'SNIEBR Chat'
link = datahmade:get('SNIEBR:'..bot_id.."group:link"..v) or ''
MNSH = datahmade:smembers('SNIEBR:'..bot_id..'creator:'..v)
MDER = datahmade:smembers('SNIEBR:'..bot_id..'owners:'..v)
MOD = datahmade:smembers('SNIEBR:'..bot_id..'mods:'..v)
ASAS = datahmade:smembers('SNIEBR:'..bot_id..'creatorbasic:'..v)
if k == 1 then
t = t..'"'..v..'":{"SNIEBR":"'..NAME..'",'
else
t = t..',"'..v..'":{"SNIEBR":"'..NAME..'",'
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/SNIEBRahmad/files_SNIEBR/master/getfile.json")
if res == 200 then
...
local Check_File_is_Found = io.open("files_SNIEBR/"..name,"r")
...
local file_bot = io.open("files_SNIEBR/"..file,"r")
if file_bot then
io.close(file_bot)
t = "*🗂┇ الملف » {"..file.."}\n📬┇ تم تعطيله وحذفه بنجاح \n✓*"
datahmade:srem("files"..bot_id,file)
else
t = "*📬┇ بالتاكيد تم تعطيل وحذف ملف » {"..file.."} \n✓*"
datahmade:srem("files"..bot_id,file)
end
local json_file, res = https.request("https://raw.githubusercontent.com/SNIEBRahmad/files_SNIEBR/master/files_SNIEBR/"..file)
if res == 200 then
os.execute("rm -fr files_SNIEBR/"..file)
...
datahmade:sadd("files"..bot_id,file)
else
...
local json_file, res = https.request("https://raw.githubusercontent.com/SNIEBRahmad/files_SNIEBR/master/files_SNIEBR/"..file)
if res == 200 then
local chek = io.open("files_SNIEBR/"..file,'w+')
...
f:write(text233)
f:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './SNIEBR_Links.txt', '', nil)  
end
------------------------------------------------------------------------
...
if (not datahmade:get('SNIEBR:'..bot_id..'bc:groups') or tonumber(sudo_add) == tonumber(msg.sender_user_id_)) then
send(msg.chat_id_, msg.id_, 1, '☑┇ ارسال الان نص او الميديا : (صوره - فديو - متحركه - ملف)', 1, 'md')
datahmade:set("SNIEBR:set_if_bc_new:pin"..bot_id..msg.sender_user_id_,"ok")
return "SNIEBR"
else
send(msg.chat_id_, msg.id_, 1, '☑┇ الاذاعه معطله ', 1, 'md')
end
...
datahmade:set("tsahke:is_del_sl:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok")
return "SNIEBR"
end  
if (text and datahmade:get("tsahke:is_del_sl:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
send(msg.chat_id_, msg.id_, 1, '☑┇تم حذف صلاحيه بنجاح', 1, 'md')
datahmade:del("SNIEBR:all_sl:"..text..bot_id..msg.chat_id_)
datahmade:srem('SNIEBR:'..bot_id..'SNIEBRnwe:slahea:'..msg.chat_id_,text)
datahmade:del("tsahke:is_del_sl:"..bot_id..msg.chat_id_..msg.sender_user_id_)
end 
if (text and text == "اضف صلاحيه") then 
send(msg.chat_id_, msg.id_, 1, '☑┇ارسال الان اسم الصلاحيه', 1, 'md')
datahmade:set("SNIEBR:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
return "SNIEBR"
end
if text and datahmade:get("SNIEBR:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_) then 
datahmade:del("SNIEBR:new:sl:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
datahmade:set("SNIEBR:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_,text)
datahmade:set("SNIEBR:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_,"ok1")
datahmade:sadd('SNIEBR:'..bot_id..'SNIEBRnwe:slahea'..msg.chat_id_,text)
return "SNIEBR"
end
if (text and datahmade:get("SNIEBR:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_)) then 
if (text == "ادمن" or text == "مدير" or text == "عضو مميز" or text == "لا شيئ") then 
datahmade:del("SNIEBR:new:sl2:"..bot_id..msg.chat_id_..msg.sender_user_id_)
tsha_text = datahmade:get("SNIEBR:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1, '☑️┇تم حفض الصلاحيه بنجاح \n⚠️┇الاوامر { رفع/تنزيل '..tsha_text..' }', 1, 'md')
datahmade:set("SNIEBR:all_sl:"..tsha_text..bot_id..msg.chat_id_,text)
datahmade:set("SNIEBRnwe:slahea:bot"..tsha_text..bot_id..msg.chat_id_,text)
datahmade:del("SNIEBR:new:sl:text:"..bot_id..msg.chat_id_..msg.sender_user_id_)
else 
send(msg.chat_id_, msg.id_, 1, '📥┇الان ارسل نوع الصلاحيه المطلوبه \n🔰┇{ `مدير` ،`ادمن` ،`عضو مميز` ,`لا شيئ `}', 1, 'md')
end
end
if text =='مسح الصلاحيات' then 
local list = datahmade:smembers('SNIEBR:'..bot_id..'SNIEBRnwe:slahea'..msg.chat_id_)
for k,v in pairs(list) do
local list = datahmade:smembers('SNIEBR:'..bot_id..'SNIEBR:users:sl'..msg.chat_id_)
for k,ks in pairs(list) do
ts_text = datahmade:get("SNIEBR:all_sl:"..v..bot_id..msg.chat_id_)
if ts_text then 
datahmade:del("SNIEBR:name_user:"..bot_id..msg.chat_id_..ks)
end
end
datahmade:del("SNIEBR:all_sl:"..v..bot_id..msg.chat_id_)
datahmade:del("SNIEBRnwe:slahea:bot"..v..bot_id..msg.chat_id_)
end
datahmade:del('SNIEBR:'..bot_id..'SNIEBRnwe:slahea'..msg.chat_id_)
...
for k,v in pairs(list) do
var = datahmade:get("SNIEBRnwe:slahea:bot"..v..bot_id..msg.chat_id_)
if var then
t = t..''..k..'- '..v..' » ('..var..')\n'
else
t = t..''..k..'- '..v..'\n'
...
ts_text = datahmade:get("SNIEBR:all_sl:"..a[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_reply(extra, result, success)
...
datahmade:sadd('SNIEBR:'..bot_id..'SNIEBR:users:sl'..msg.chat_id_,result.sender_user_id_)
function keko33332(extra,result2,success)
info = '👤┇العضو ~⪼ ['..result2.first_name_..'](t.me/'..(result2.username_ or '• اهلا بك عزيزي 🔎 •\n• لايمكنك استخدام البوت 🔖 •\n• عليك الاشتراك في القناة ✏️ •\n• @SNIEBR ⚜️\n', 1, 'html')')..')\n☑┇تم رفعه '..a[1]
send(msg.chat_id_, msg.id_, 1,info, 1, 'md')
end
...
ts_text = datahmade:get("SNIEBR:all_sl:"..apmd[1]..bot_id..msg.chat_id_)
if ts_text then 
function promote_by_username(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
...
datahmade:sadd('SNIEBR:'..bot_id..'SNIEBR:users:sl'..msg.chat_id_,result.id_)
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'SNIEBR')..')\n☑┇تم رفعه '..apmd[1]
else
texts = '✖┇خطاء'
end
...
datahmade:sadd('SNIEBR:'..bot_id..'SNIEBR:users:sl'..msg.chat_id_,apmd[2])
...
datahmade:srem('SNIEBR:'..bot_id..'SNIEBR:users:sl'..msg.chat_id_,result.sender_user_id_)
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apmd[2] or 'SNIEBR')..')\n🔰┇تم تنزيله من '..apmd[1]
datahmade:srem('SNIEBR:'..bot_id..'SNIEBR:users:sl'..msg.chat_id_,result.id_)
...
datahmade:srem('SNIEBR:'..bot_id..'SNIEBR:users:sl'..msg.chat_id_,apmd[2])
end
end
...
texts = '👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(apki[2] or 'SNIEBR')..')\n🚫┇تم طرده من المجموعه'
chat_kick(msg.chat_id_, result.id_)
end
else
texts = '✖┇خطاء'
...
elseif (datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.id_) and datahmade:get("SNIEBR:all_sl:"..datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.id_) ..bot_id..msg.chat_id_)) then 
...
elseif (datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) and datahmade:get("SNIEBR:all_sl:"..datahmade:get("SNIEBR:name_user:"..bot_id..msg.chat_id_..result.sender_user_id_) ..bot_id..msg.chat_id_)) then 
...
------------------------------------------------------------------------
if (text and text == (redis:get('SNIEBR:'..bot_id..'name_bot') or 'تشاكي'))then
name_bot = (redis:get('SNIEBR:'..bot_id..'name_bot') or 'تشاكي')
local namebot = {
...
ikeko_text = "اقوئ تفاعل🙋"
elseif tonumber(user_msgs) < 4000 then 
ikeko_text = "متفاعل قوي🕵"
elseif tonumber(user_msgs) < 5000 then 
ikeko_text = "جيد بتفاعل🕊"
elseif tonumber(user_msgs) > 5000 then 
ikeko_text = "اسد التفاعل 🐷"
end
keko = datahmade:smembers('keko:all:pppp:tt:'..bot_id) or 0
...
if not datahmade:get("SNIEBR:gr:id:text:"..bot_id..msg.chat_id_) then 
send(msg.chat_id_, msg.id_, 1, "🎟¦ ايديـك • ("..msg.sender_user_id_..")\n🎭¦ معرفك • "..keko_info.."\n📌¦ موقعـك • "..t.."\n💌¦ رسائلك • {"..user_msgs.."}\n👮‍♀️¦ سحكاتك • {"..edit.."}\n🎲¦ تفاعـلك • "..ikeko_text.."\n💎¦ مجوهرآتك • {"..nko.."}\nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ ", 1, 'html')
else 
local SNIEBR_new_text = datahmade:get("SNIEBR:gr:id:text:"..bot_id..msg.chat_id_)
local SNIEBR_new_text = SNIEBR_new_text:gsub('#username',(keko_info or 'لا يوجد'))
local SNIEBR_new_text = SNIEBR_new_text:gsub('#id',(msg.sender_user_id_ or 'لا يوجد'))
...
------------------------------------------------------------------------
if text == 'الاسرع' or text =='اسرع' and datahmade:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
...
------------------------------------------------------------------------
if text == 'حزوره' or text =='حزورة' and datahmade:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
...
------------------------------------------------------------------------
if text == 'المعاني' or text =='معاني' and datahmade:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
...
------------------------------------------------------------------------
if text == 'ترتيب' and datahmade:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
datahmade:del('SNIEBR:'..bot_id..'l:id2'..msg.chat_id_)
katu = {'فاصوليه','بجامه','درنفيس','علاكه','زمال','خاشوكه','فلافل','صابونه','مطي','زربه','فسوه','تاير','خنينه','ظرطه','خريه','جلافه','ليفه'}
name = katu[math.random(#katu)]
datahmade:set('SNIEBR:'..bot_id..'means'..msg.chat_id_,name)
name = string.gsub(name,'فسوه','ف و س ه')
name = string.gsub(name,'زربه','ز ب ر ه')
name = string.gsub(name,'تاير','ت ا ر ي')
name = string.gsub(name,'خنينه','خ ن ي ه ن')
name = string.gsub(name,'ظرطه','ظ ط ر ه')
name = string.gsub(name,'خريه','خ ر ه ي')
name = string.gsub(name,'جلافه','ج ف ل ا ه')
name = string.gsub(name,'ليفه','ل ف ي ه')
name = string.gsub(name,'مطي','ي ط  م')
name = string.gsub(name,'صابونه','ص و ن ا ب ه')
name = string.gsub(name,'فلافل','ل ف ا ف ل')
name = string.gsub(name,'خاشوكه','خ ش ا ك و ه')
name = string.gsub(name,'زمال','م ز ا ل')
name = string.gsub(name,'علاكه','ع ا ك ل ه')
name = string.gsub(name,'درنفيس','د ر ف ن ي س')
name = string.gsub(name,'بجامه','ب ا م ج')
name = string.gsub(name,'فاصوليه','ف ا ل ي ه ص و')
taha = '*🎉┇اسرع واحد يرتبها » {'..name..'}\n🎮┇يحصل على نقطه ارسل ترتيب ,*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
end
------------------------------------------------------------------------
if text == ''..(datahmade:get('SNIEBR:'..bot_id..'means'..msg.chat_id_) or 'لفاتع')..'' and not datahmade:get('SNIEBR:'..bot_id..'l:id2'..msg.chat_id_) then
if not datahmade:get('SNIEBR:'..bot_id..'l:id2'..msg.chat_id_) then 
taha = '*🎉¦ مبروك لقد ربحت نقطه ,\n🎮| للعب مره اخرى ارسل ترتيب ,*'
send(msg.chat_id_, msg.id_, 1,taha, 1, 'md')
datahmade:incrby('SNIEBR:'..bot_id..'add:num'..msg.chat_id_..msg.sender_user_id_, 1)
datahmade:incrby('SNIEBR:'..bot_id..'add:numall'..msg.chat_id_..msg.sender_user_id_, 1)    
end
...
------------------------------------------------------------------------
if text == 'العكس' or text =='عكس' and datahmade:get('SNIEBR:'..bot_id..'lock_geam'..msg.chat_id_) then
...
datahmade:srem("thsake:gog"..bot_id, '-100'..data.channel_.id_)
...
local Bots = datahmade:get("lock_bot:SNIEBR"..msg.chat_id_..bot_id)
for i=0,#mem_id do  
...
if msg.content_.ID == "MessageChatAddMembers" then  
local mem_id = msg.content_.members_  
local Bots = datahmade:get("lock_botAndBan:SNIEBR"..msg.chat_id_..bot_id) 
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and not is_mod(msg) and Bots then   
...
local Name_Bot = (redis:get('SNIEBR:'..bot_id..'name_bot') or 'تشاكي')
...
------------------------------------------------------------------------
--         »»                 End UpdateChat                          ««              --
elseif (data.ID == "UpdateOption" and data.name_ == "my_id") then  local list = datahmade:smembers('SNIEBR:'..bot_id.."userss") for k,v in pairs(list) do tdcli_function({ID='GetChat',chat_id_ = v},function(arg,data) end,nil) end 
local list = datahmade:smembers('SNIEBR:'..bot_id..'groups') 
for k,v in pairs(list) do 
...
datahmade:srem("thsake:gog"..bot_id,v) 
...
datahmade:sadd("thsake:gog"..bot_id,v) 
...
local msg = data.message_
local text = msg.content_.text_
local Get_Msg_Pin = datahmade:get('SNIEBR:'..bot_id..'Msg_Text'..msg.chat_id_)
if Get_Msg_Pin ~= nil then
if text == Get_Msg_Pin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) if d.ID == 'Ok' then;datahmade:del('SNIEBR:'..bot_id..'Msg_Text'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
print(msg.content_.sticker_.sticker_.persistent_id_)
if Get_Msg_Pin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) datahmade:del('SNIEBR:'..bot_id..'Msg_Text'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.voice_) then
